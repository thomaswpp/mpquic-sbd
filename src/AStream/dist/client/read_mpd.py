...
def get_url_list(media, segment_duration,  playback_duration, bitrate, playback):
    """
    ...
    # Counting the init file
        ...
        if "$RepresentationID" in base_url:
            base_url = base_url.replace("$RepresentationID$", media.id_name)
...
def read_mpd(mpd_file, dashplayback, bitratefilter = None, playback='basic'):
            ...
            if 'mimeType' in adaptation_set.attrib:
                ...
                if media_found:
                    ...
                    for representation in adaptation_set:
                        ...
                        id_name  = representation.attrib['id']
                        ...
                        media_object[bandwidth].id_name = id_name
