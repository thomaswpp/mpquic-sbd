...
* [src/quic-go](https://github.com/thomaswpp/mpquic-sbd/tree/master/src/quic-go): the popular [MPQUIC implementation](https://multipath-quic.org/) in golang we extend to include SBD (the RFC8382 Standard for Shared Bottleneck Detection).
...
# 3 Quickstart to reproduce the experimental setup from a prepared VM image
